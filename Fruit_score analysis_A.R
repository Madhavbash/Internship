...
##Predicting
### I think with all the predictions you get the same graph,but with percentages.
### You could directly calculate the percentages, or make a data frame with all
### the predictions and plot the same plot. Not very interesting. 
